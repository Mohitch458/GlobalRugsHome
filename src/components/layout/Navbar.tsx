              ...
              <div className="w-full max-w-sm px-8 mt-4 flex flex-col items-center sm:items-start text-center sm:text-left">
                ...
                <div className="flex flex-row justify-center gap-6 flex-wrap w-full py-2">
                  ...
                  <a href="https://globalrughome.etsy.com" target="_blank" rel="noopener noreferrer" className="flex items-center text-foreground/80 hover:text-gold transition-colors" aria-label="Etsy Shop">
                    <svg width="24" height="24" viewBox="0 0 24 24" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M12 2C6.47 2 2 6.47 2 12s4.47 10 10 10 10-4.47 10-10S17.53 2 12 2zm3.77 13.06c0 .35-.14.68-.4.92s-.6.37-.96.37H9.59c-.36 0-.7-.13-.96-.37a1.275 1.275 0 0 1-.4-.92V8.94c0-.35.14-.68.4-.92.26-.24.6-.37.96-.37h4.82c.36 0 .7.13.96.37.26.24.4.57.4.92v1.17h-1.5V9.44h-3.32v1.78h2.57v1.5h-2.57v1.89h3.32v-1.06h1.5v1.06z"/></svg>
                  </a>
