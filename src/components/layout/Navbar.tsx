...
{/* Contact & Social Section */}
              <div className="w-full max-w-sm px-8 mt-4 flex flex-col items-center sm:items-start text-center sm:text-left">
                ...
                <div className="flex flex-row justify-center gap-6 flex-wrap w-full py-2">
                  ...
                  <a href="https://www.amazon.com/s?ie=UTF8&marketplaceID=ATVPDKIKX0DER&me=A2Y0L8AKTLT1LI" target="_blank" rel="noopener noreferrer" className="flex items-center text-foreground/80 hover:text-gold transition-colors" aria-label="Amazon Store">
                  ...
                  <a href="https://globalrughome.etsy.com" target="_blank" rel="noopener noreferrer" className="flex items-center text-foreground/80 hover:text-gold transition-colors" aria-label="Etsy Shop">
                    <svg width="24" height="24" viewBox="0 0 384 512" fill="currentColor" xmlns="http://www.w3.org/2000/svg"><path d="M384 348c-1.8 10.8-13.8 110-15.5 132-117.9-4.3-219.9-4.7-368.5 0v-25.5c45.5-8.9 60.6-8 61-35.3 1.8-72.3 3.5-244.1 0-322-1-28.5-12.1-26.8-61-36v-25.5c73.9 2.4 255.9 8.6 363-3.8-3.5 38.3-7.8 126.5-7.8 126.5H332C320.9 115.7 313.2 68 277.3 68h-137c-10.3 0-10.8 3.5-10.8 9.8V241.5c58 .5 88.5-2.5 88.5-2.5 29.8-1 27.6-8.5 40.8-65.3h25.8c-4.4 101.4-3.9 61.8-1.8 160.3H257c-9.2-40.1-9.1-61-39.5-61.5 0 0-21.5-2-88-2v139c0 26 14.3 38.3 44.3 38.3H263c63.6 0 66.6-25 98.8-99.8H384z"/></svg>
                  </a>
